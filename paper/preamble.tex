...
\newcommand{\ch}[2]{\textsf{ch}^{#1}\langle{#2}\rangle}

\newcommand{\arity}[1]{\text{arity}(#1)}
\newcommand{\guard}[1]{\text{guard}(#1)}
\newcommand{\LogicalAgreeRen}[3]{\textit{logical-agree-ren}({#1},{#2},{#3})}
\newcommand{\LogicalAgreeSubst}[3]{{{#1} \vdash {#2} \dashv {#3}}}
\newcommand{\HeadSim}[2]{\text{headSim}({#1},{#2})}
\newcommand{\Sim}[2]{\text{sim}({#1},{#2})}
...
\newcommand{\Root}[2]{\textsf{Root}({#1}, {#2})}
\newcommand{\Node}[3]{\textsf{Node}({#1}, {#2}, {#3})}
\newcommand{\Poised}{\text{Poised}}
\newcommand{\Terminal}{\text{Terminal}}
