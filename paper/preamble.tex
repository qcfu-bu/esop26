...
\newcommand{\recvI}[1]{\underline{\textbf{\textsf{recv}}}\,{#1}}
\newcommand{\recvR}[1]{\textbf{\textsf{recv}}\,{#1}}
\newcommand{\sendI}[1]{\underline{\textbf{\textsf{send}}}\,{#1}}
\newcommand{\sendR}[1]{\textbf{\textsf{send}}\,{#1}}
\newcommand{\close}[1]{\textbf{\textsf{close}}\,{#1}}
\newcommand{\wait}[1]{\textbf{\textsf{wait}}\,{#1}}
