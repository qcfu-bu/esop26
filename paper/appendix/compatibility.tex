...
\end{lemma}
\begin{proof}
  By induction on the derivation of $\Gamma \vdash \CM{A} : B$.
\end{proof}
...
\end{lemma}
\begin{proof}
  By induction on the derivation of $\Gamma \vdash \CH{A} : B$.
\end{proof}
...
\end{lemma}
\begin{proof}
  By induction on the derivation of $\Gamma \vdash \HC{A} : B$.
\end{proof}
...
\end{lemma}
\begin{proof}
  By induction on the derivation of $\Gamma \vdash \ActR{\rho}{x : A}{B} : C$.
\end{proof}
