...
Given the \textsf{queue} protocol described above, we can construct queue process nodes and
...
We implement a prototype compiler for compiling \TLLC{} programs into safe C
