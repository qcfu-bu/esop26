...
We define the sequential mergesort algorithm, as a point of reference,
in the usual way using \textsf{split} and \textsf{merge} helper functions.
We will not go into further details regarding the well-founded recursion
of \textsf{msort} or the correctness of sorting as these are well-known results~\cite{cpdt}.
